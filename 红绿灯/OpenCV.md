...
<font style="color:rgb(15, 17, 21);">表示每个像素的</font>**<font style="color:rgb(15, 17, 21);">不透明度，</font>**<font style="color:rgb(15, 17, 21);">取值范围：0（完全透明）~ 255（完全不透明）</font>
...
<h4 id="cqYHO"><font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);background-color:#FBDE28;">注意区分：</font></h4>
<font style="color:rgb(15, 17, 21);">1./home/ = 所有人的</font>

<font style="color:rgb(15, 17, 21);">2./home/zhao/ = 自己的</font>
...
<h3 id="2592a32c"><font style="color:rgb(15, 17, 21);">VideoCapture </font></h3>
<font style="color:rgb(15, 17, 21);"> 是OpenCV中用于视频捕获的类</font>

<font style="color:rgb(15, 17, 21);">可以从摄像头实时捕获视频，从视频文件读取帧，从图像序列读取帧</font>

**<font style="color:rgb(15, 17, 21);">总结</font>**<font style="color:rgb(15, 17, 21);">来说就是读取视频或者读取帧的工具</font>
...
<h3 id="7a9f7cfa"><font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);background-color:#FBDE28;">Mat内容</font></h3>
...
就是把斜的文档正过来，写上校正值，其实和调hsv一样，只要手动就要一点一点调
...
<font style="color:rgb(15, 17, 21);">这个是用来确定颜色的，定颜色的，是这三个里面最重要的可以说是</font>
...
<h4 id="QnJUX"><font style="color:rgb(15, 17, 21);">2.S（饱和度）- 颜色有多浓 </font></h4>
<h4 id="hznxp">颜色的深浅，红有多红绿有多绿来着</h4>
...
<h4 id="FEArW"><font style="color:rgb(15, 17, 21);">3.V（明度）- 颜色有多亮 （最不重要的一个，只要不是细节区分直接拉满）</font></h4>
